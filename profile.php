...
<body>
  <div style="display:flex; justify-content: space-between;">
    ...
    <div>
 <a href="http://localhost/login-system/profile.php"><img src="images/IMD_LOGO.png"  width="80" height="75" align="centre"> </a>    </div>
  ...
  <div id="main">
    ...
    <nav>
      ...
      if (!$flag) {
       ...
       $conn = new mysqli("localhost","root","India@123","imd");
       $sql="SELECT * FROM ip";
    ...
    if(isset($_SESSION['email'])){
      ...
      if ((time() - $_SESSION['loggedin_time']) > 300) {
        $_SESSION['flag']=1;
        if ($_SESSION['flag']===1) {
      ...
      //style="position: absolute;top: 94px;margin-left: 182px;
        ...
        // echo "<div id='aside'>";
        echo "<h2><center><font size='5' style='color: cadetblue;position: absolute;top: 113px;margin-left: 320px;'
