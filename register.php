...
if ( $result->num_rows > 0 ) {
    ...
    // header("location: error.php");
        ...
        echo "<b><h3 style='position:fixed; bottom: 70px; width:100%; text-align:center'>User with this email already exists!</h3></b>";
        echo "</div>";
}
    ...
    if (!$mysqli->query($sql)  ){
        ...
        // header("location: error.php");
            echo "<div style='position: relative'>";
        echo "<b><h3 style='position:fixed; bottom: 70px; width:100%; text-align:center'>Registration Failed!</h3></b>";
        echo "</div>";
    }
    else{
